...
urlpatterns = [
    ...
    path('admin_prestamos/', views.admin_prestamos_list, name='admin_prestamos_list'),
    path('admin_prestamos/<int:pk>/eliminar/', views.admin_prestamo_delete, name='admin_prestamo_delete'),
]
